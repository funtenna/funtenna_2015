...
.equ symbol_duration, 0x2f

.equ xmit_msg_word, 0b10101010101010101010101010101010
@.equ xmit_msg_word, 0b00000001000100010001000000010001
@.equ xmit_msg_word, 0b00000000000001000000000000000001
@.equ xmit_msg_word, 0b11111111111111111111111111111111
@.equ xmit_msg_word, 0b11011101111011101101000101010011
    ...
    SUB     SP, SP, #0x40
    LDR     R0, =mem_start
    STR     R0, [SP, #0x24] @ cur_mem pointer
    LDRH    R0, [R0]
    STR     R0, [SP, #0x20] @ spin_period on stack
...
_reset_symbol:
    LDR     R0, [SP, #0x24] @ cur_mem pointer
    ADD     R0, #0x2
    STR     R0, [SP, #0x24] @ cur_mem pointer
    LDRH    R0, [R0]
    LSL     R0, #0x2 
    STR     R0, [SP, #0x20] @ cur spin period
...
xmit_msg_str:   .asciz "UUABCD\xff\xff\x00\x00\x00\x00"
